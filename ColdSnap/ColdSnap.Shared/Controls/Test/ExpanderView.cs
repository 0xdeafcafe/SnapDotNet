...
namespace ColdSnap.Controls.Test
{
	...
	public class ExpanderView : HeaderedItemsControl
	{
		...
		public static readonly DependencyProperty ExpanderProperty = DependencyProperty.Register(
			"Expander", typeof(object), typeof(ExpanderView), new PropertyMetadata(default(object), OnExpanderPropertyChanged));
		...
		public static readonly DependencyProperty ExpanderTemplateProperty = DependencyProperty.Register(
			"ExpanderTemplate", typeof(DataTemplate), typeof(ExpanderView), new PropertyMetadata(default(DataTemplate), OnExpanderTemplatePropertyChanged));
		...
		public static readonly DependencyProperty NonExpandableHeaderProperty = DependencyProperty.Register(
			"NonExpandableHeader", typeof(object), typeof(ExpanderView), new PropertyMetadata(default(object), OnNonExpandableHeaderPropertyChanged));
		...
		public static readonly DependencyProperty NonExpandableHeaderTemplateProperty = DependencyProperty.Register(
			"NonExpandableHeaderTemplate", typeof(DataTemplate), typeof(ExpanderView), new PropertyMetadata(default(DataTemplate), OnNonExpandableHeaderTemplatePropertyChanged));
		...
		public static readonly DependencyProperty IsExpandedProperty = DependencyProperty.Register(
			"IsExpanded", typeof(bool), typeof(ExpanderView), new PropertyMetadata(default(bool), OnIsExpandedPropertyChanged));
		...
		public static readonly DependencyProperty HasItemsProperty = DependencyProperty.Register(
			"HasItems", typeof(bool), typeof(ExpanderView), new PropertyMetadata(default(bool)));
		...
		public static readonly DependencyProperty IsNonExpandableProperty = DependencyProperty.Register(
			"IsNonExpandable", typeof(bool), typeof(ExpanderView), new PropertyMetadata(default(bool), OnIsNonExpandablePropertyChanged));
		...
		private void OnSizeChanged(object sender, SizeChangedEventArgs e)
		{
			...
			var parent = _presenter.GetParentByType<ExpanderView>();
