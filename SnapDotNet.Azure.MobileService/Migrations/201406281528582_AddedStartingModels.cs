namespace SnapDotNet.Azure.MobileService.Migrations
{
	...
	public partial class AddedStartingModels : DbMigration
	{
		public override void Up()
		{
			CreateTable(
				"snapdotnet.SnapchatAddedFriends",
				c => new
					{
				...
				c => new
					{
						...
						UserId = c.Long(nullable: false),
						SnapId = c.String(),
						SnapMediaId = c.String(),
						SnapStatus = c.Int(nullable: false),
						SenderName = c.String(),
						CreatedAt = c.DateTimeOffset(nullable: false, precision: 7,
							annotations: new Dictionary<string, AnnotationValues>
                            {
		...
		public override void Down()
		{
			...
			DropTable("snapdotnet.SnapchatSnaps",
				removedColumnAnnotations: new Dictionary<string, IDictionary<string, object>>
                {
                    {
                        "CreatedAt",
			...
			DropTable("snapdotnet.SnapchatChats",
				removedColumnAnnotations: new Dictionary<string, IDictionary<string, object>>
                {
                    {
                        "CreatedAt",
			...
			DropTable("snapdotnet.SnapchatAddedFriends",
				removedColumnAnnotations: new Dictionary<string, IDictionary<string, object>>
                {
                    {
                        "CreatedAt",
